  ...
  return (
    <ScrollView className="flex-1 bg-neutral-50 dark:bg-black" contentContainerClassName="p-4 pb-16 gap-3">
      ...
      <View className="flex-row gap-3">
        <Field label={mode === 'label' ? 'Serving size (g/ml)' : 'Serving size (g/ml)'} value={servingSize} onChangeText={setServingSize} keyboardType="decimal-pad" className="flex-1" />
        {mode === 'label' ? (
          <Field label="Servings / pack" value={servingsPerPack} onChangeText={setServingsPerPack} keyboardType="decimal-pad" className="flex-1" />
        ) : (
